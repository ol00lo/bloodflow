...
TEST_CASE("improper graph definition", "[improper_graph]") {
	CHECK_THROWS(bflow::VesselGraph({ {0,1,2} }, { 1.0, 2.0 }));
	CHECK_THROWS(bflow::VesselGraph({ {0,1,2}, {0}, {1}, {2} }, { 1.0, 2.0 }));
	CHECK_THROWS(bflow::VesselGraph({ {0,1,2}, {0}, {1}, {1} }, { 1.0, 2.0, 3.0 }));
	CHECK_THROWS(bflow::VesselGraph({ {0,1,2}, {0}, {1} }, { 1.0, 2.0 }));
	CHECK_THROWS(bflow::VesselGraph({ {0,1,2,2}, {0}, {1} }, { 1.0, 2.0 }));
	CHECK_THROWS(bflow::VesselGraph({ {0,1,2,2}, {0}, {1} }, { 1.0, 2.0, 3.0 }));
}
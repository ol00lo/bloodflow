...
void solve_nonlinear_system(const INonlinearSystem6& sys, double& x1, double& x2, double& x3, double& x4, double& x5, double& x6, double eps=1e-12, size_t maxit=10'000);
